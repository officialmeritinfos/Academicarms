                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                        <a href="<?php echo base_url();?>teachers/positions"><button class="btn btn-info"><i class="fa fa-file-o"></i> Add Position</button></a>
                    </p>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <?php echo form_open('teachers/positions/edit','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/positions/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
    ...
    <script type="text/javascript">
        $('#edit_classes').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/positions/get_position_id/'+recipient,
                    type: "GET",
                    dataType: "json",
