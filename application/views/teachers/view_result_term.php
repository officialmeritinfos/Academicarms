                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>teachers/results/view_result_class/<?php echo htmlentities($result->Session);?>/<?php echo htmlentities($result->Semester);?>"><button class="btn-primary btn-sm btn" title="Edit"><i class="fa fa-eye"></i></button></a>
