                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($results->result() as $result): 
                          ...
                          $session=$this->db->select('*')->from('Session')->where('Session_id',$result->Session)->get();
                          $term=$this->db->select('*')->from('Semester')->where('Semester_id',$result->Semester)->get();
                          $subject=$this->db->select('*')->from('Subject')->where('Subject_id',$result->Subject)->get();
                          $cnt++; 
                        ?>
                        <tr>
                          <td><?php echo $cnt;?></td>
                          ...
                          <td><?php echo htmlentities($session->row()->Name);?></td>
                          ...
                          <td><?php echo htmlentities($result->Unit_point);?></td>
                          <td>
                            <?php if ($result->Status==1):?>
                            <label class="label label-success">Published</label>
                            <?php else:?>
                              <label class="label label-info">Unpublished</label>
                            <?php endif?>
                          </td>
                          <td>
                            <button class="btn-primary btn-sm btn" title="Edit" data-toggle="modal" data-target="#edit_classes" data-value="<?php echo htmlentities($result->Result_id);?>"><i class="fa fa-edit"></i></button>
                            <button class="btn-danger btn-sm btn" title="Delete" data-toggle="modal" data-target="#delete_classes" data-value="<?php echo htmlentities($result->Result_id);?>"><i class="fa fa-times"></i></button>
                          </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/results/create','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="edit_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/results/edit','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                            ...
                            <div class="form-group" style="display: none;">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Subject Id<span class="required" style="color: red;">*</span>
                              </label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="first-name" name="subid" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Exam Score<span class="required" style="color: red;">*</span>
                              </label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="first-name" name="examscore" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Test Score<span class="required" style="color: red;">*</span>
                              </label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="first-name" name="testscore" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Status<span class="required" style="color: red;">*</span>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/results/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="truncate" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/results/truncate','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
    ...
    <script type="text/javascript">
        $('#edit_classes').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/results/get_student_result/'+recipient,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('input[name="examscore"]').val(value.Exam_score);
                            $('input[name="testscore"]').val(value.Test_score);
                            $('input[name="id"]').val(value.Result_id);
                            $('input[name="subid"]').val(value.Subject_id);
                        });
                    }
                });
            }
