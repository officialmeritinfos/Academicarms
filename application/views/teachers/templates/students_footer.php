                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/students/create','class="form-horizontal form-label-left input_mask"');?>
                          <div class="form"><br>
...
<!--========================================Start of modal for Adding(Batch)==========================-->
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/students/create_batch','class="form-horizontal form-label-left input_mask"');?>
                          <div class="form"><br>
                            <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                              <select class="form-control input-lg" id="inputSuccess3" name="class">
                                <option value="">Select Class</option>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="promote_demote" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/students/promote_demote','class="form-horizontal form-label-left input_mask"');?>
                          <div class="form"><br>
                            <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                              <select class="form-control input-lg" id="inputSuccess3" name="class">
                                <option value="">Select Class</option>
                                <?php foreach ($classs->result() as $class):?>
                                  <option value="<?php echo htmlentities($class->Class_id);?>"><?php echo htmlentities($class->Name);?></option>
                                <?php endforeach;?>
                              </select>
                              <span class="fa fa-book form-control-feedback right" aria-hidden="true"></span>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('teachers/students/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
