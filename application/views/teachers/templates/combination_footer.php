                  ...
                  <div class="modal fade bs-example-modal-lg" id="truncate" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/subjects_combination/truncate','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
...
<script type="text/javascript">
  $(document).ready(function() {
    var subfield='<div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback"><input type="text" class="form-control input-lg" id="inputSuccess3" placeholder="Start Typing Subject Name" name="subject[]"><span class="fa fa-map form-control-feedback right" aria-hidden="true"></span></div>';
