                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      ...
                      <button class="btn btn-primary" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i> Add Students</button><button class="btn btn-primary" data-toggle="modal" data-target="#create_batch"><i class="fa fa-plus"></i> Add Students(Batch)</button>
