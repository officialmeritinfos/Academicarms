                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     <a href="<?php echo base_url();?>admin/results" class="btn btn-primary"><i class="fa fa-plus"></i> Add Results</a>
                    </p>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="edit_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/results/edit','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/results/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
    ...
    <script type="text/javascript">
        $('#edit_classes').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>admin/results/get_student_result/'+recipient,
                    type: "GET",
                    dataType: "json",
