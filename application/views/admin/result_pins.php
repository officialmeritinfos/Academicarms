                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30 text-center text-danger" style="font-size: 16px;" >
                      Pins Once Generated cannot be altered. You can only delete them but cannot edit it.
                    </p>
                    <p class="text-muted font-13 m-b-30">
                     <button class="btn btn-info" data-toggle="modal" data-target="#create_position"><i class="fa fa-key"></i> Add Result Pin</button>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($pins->result() as $pin): 
                          $usage=$this->db->select('*')->from('Pin_usage')->where('Pin_id',$pin->Pin_id)->get();
                          $cnt++; 
                        ?>
                        <tr>
                          <td><?php echo $cnt;?></td>
                          ...
                          <td><?php echo htmlentities($usage->num_rows());?></td>
                          <td>
                            <?php 
                            if ($pin->Status==1):?>
                              <label class="label label-success">Not Used</label>
                            <?php elseif ($pin->Status==2):?>
                              <label class="label label-info">In Used</label>
                            <?php else:?>
                              <label class="label label-danger">Already Used</label>
                            <?php endif;?>
                          </td>
                          <td>
                            <button class="btn btn-danger btn-sm" title="Delete" data-toggle="modal" data-target="#delete_classes" data-value="<?php echo htmlentities($pin->Pin_id);?>"><i class="fa fa-times-circle"></i></button>
                          </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/result_pins/create','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Number To Create <span class="required" style="color: red;">*</span>
                              </label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="last-name" name="num_add" type="number" rows="1" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/result_pins/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="truncate" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/result_pins/truncate','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
