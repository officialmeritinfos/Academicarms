                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     <button class="btn btn-primary" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i> Add Result</button><a href="<?php echo base_url();?>admin/grades" class="btn btn-primary"><i class="fa fa-plus"></i> Add Grades</a><button class="btn btn-danger" data-toggle="modal" data-target="#truncate"><i class="fa fa-ban"></i> Delete Every Data</button>
                     <?php
                     if ($general_settings->row()->Result_type==2):?>
                     <a href="<?php echo base_url();?>admin/positions" class="btn btn-info"><i class="fa fa-file-o"></i> Add Position</a>
                    <?php endif;?>
                    </p>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>admin/results/view_result_term/<?php echo htmlentities($result->Session);?>"><button class="btn-primary btn-sm btn" title="Edit"><i class="fa fa-eye"></i></button>
