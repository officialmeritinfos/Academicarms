                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>admin/students/view_students/<?php echo htmlentities($student->Class);?>"><button class="btn-primary btn-sm btn" title="View Contents"><i class="fa fa-eye"></i></button></a>
                          </td>
                          <td>
