                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($results->result() as $result): 
                          $class=$this->db->select('*')->from('Classes')->where('Class_id',$result->Class)->get();
                          $cnt++; 
                        ?>
                        <tr>
                          <td><?php echo $cnt;?></td>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>admin/results/view_result_students/<?php echo htmlentities($result->Session);?>/<?php echo htmlentities($result->Semester);?>/<?php echo htmlentities($result->Class);?>"><button class="btn-primary btn-sm btn" title="Edit"><i class="fa fa-eye"></i></button>
