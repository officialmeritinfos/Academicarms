                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     <button class="btn btn-primary" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i> Add Session</button><button class="btn btn-danger" data-toggle="modal" data-target="#truncate"><i class="fa fa-ban"></i> Delete Every Data</button>
                    </p>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn-primary btn-sm btn" title="Edit Session" data-toggle="modal" data-target="#edit_classes" data-value="<?php echo htmlentities($session->Session_id);?>"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger btn-sm" title="Delete Session" data-toggle="modal" data-target="#delete_classes" data-value="<?php echo htmlentities($session->Session_id);?>"><i class="fa fa-times-circle"></i></button>
                          </td>
                          <td>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/academic_sessions/create_session','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="edit_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/academic_sessions/edit','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/academic_sessions/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="truncate" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/academic_sessions/truncate','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
    ...
    <script type="text/javascript">
        $('#edit_classes').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>admin/academic_sessions/get_session_id/'+recipient,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('input[name="id"]').val(value.Session_id);
                        });
                    }
                });
            }
