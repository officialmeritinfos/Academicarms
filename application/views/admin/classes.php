<!-- page content -->
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     <button class="btn btn-primary" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i> Add Class</button><button class="btn btn-danger" data-toggle="modal" data-target="#truncate"><i class="fa fa-ban"></i> Delete Every Data</button>
                    </p>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn-primary btn-sm btn" title="Edit Class" data-toggle="modal" data-target="#edit_classes" data-value="<?php echo htmlentities($class->Class_id);?>"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger btn-sm" title="Delete Class" data-toggle="modal" data-target="#delete_classes" data-value="<?php echo htmlentities($class->Class_id);?>"><i class="fa fa-times-circle"></i></button>
                          </td>
                          <td>
              ...
              <!--========================================End of Table Row================================-->
              <!--========================================Start of modal for Adding Class==========================-->
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/classes/create_class','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
              ...
              <!--========================================Start of modal for Editing Class==========================-->
                  <div class="modal fade bs-example-modal-lg" id="edit_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/classes/edit_class','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                            ...
                            <div class="form-group" style="display: none;">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="first-name" name="class_id" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Status<span class="required" style="color: red;">*</span>
              ...
              <!--========================================End of modal for Editing Class==========================-->
              <!--========================================Start of modal for Deleting Class==========================-->
                  <div class="modal fade bs-example-modal-lg" id="delete_classes" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/classes/delete','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="truncate" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/classes/truncate','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
    ...
    <script type="text/javascript">
        $('#edit_classes').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>admin/classes/get_class_id/'+recipient,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('input[name="class_id"]').val(value.Class_id);
                        });
                    }
                });
            }
    ...
    <script type="text/javascript">
        $('#delete_classes').on('show.bs.modal', function (event) {
            ...
            // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            $('input[name="class_id"]').val(recipient);
        })
    </script>
  </body>
</html>