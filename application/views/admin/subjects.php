                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     <button class="btn btn-primary" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i> Add Data</button><button class="btn btn-primary" data-toggle="modal" data-target="#create_batch"><i class="fa fa-plus"></i> Add Data(Batch)</button><button class="btn btn-danger" data-toggle="modal" data-target="#truncate"><i class="fa fa-ban"></i> Delete Every Data</button>
                    </p>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn-primary btn-sm btn" title="Edit" data-toggle="modal" data-target="#edit_classes" data-value="<?php echo htmlentities($subject->Subject_id);?>"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger btn-sm" title="Delete" data-toggle="modal" data-target="#delete_classes" data-value="<?php echo htmlentities($subject->Subject_id);?>"><i class="fa fa-times-circle"></i></button>
                          </td>
                          <td>
