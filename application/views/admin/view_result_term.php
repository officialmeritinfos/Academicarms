                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($results->result() as $result): 
                          $sem=$this->db->select('*')->from('Semester')->where('Semester_id',$result->Semester)->get();
                          $cnt++; 
                        ?>
                        <tr>
                          <td><?php echo $cnt;?></td>
                          <td><?php echo htmlentities($sem->row()->Name);?></td>
                          <td>
                            <a href="<?php echo base_url();?>admin/results/view_result_class/<?php echo htmlentities($result->Session);?>/<?php echo htmlentities($result->Semester);?>"><button class="btn-primary btn-sm btn" title="Edit"><i class="fa fa-eye"></i></button>
