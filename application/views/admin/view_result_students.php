                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>admin/results/view_student_result/<?php echo htmlentities($result->Session);?>/<?php echo htmlentities($result->Semester);?>/<?php echo htmlentities($result->Class);?>/<?php echo htmlentities($result->Student);?>"><button class="btn-primary btn-sm btn" title="View"><i class="fa fa-eye"></i></button>
