        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     <button class="btn btn-info" data-toggle="modal" data-target="#create_position"><i class="fa fa-file-o"></i> Add Position</button>
                     <a href="<?php echo base_url();?>admin/result_type"><button class="btn btn-primary"><i class="fa fa-plus"></i> Add Result Type</button></a>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>admin/positions/view_position_semester/<?php echo htmlentities($position->Session);?>"><button class="btn-primary btn-sm btn" title="Edit"><i class="fa fa-eye"></i></button>
              ...
              <!--========================================End of Table Row================================-->
              <!--========================================Start of modal for Adding Position==========================-->
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/positions/create_position','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
              ...
              <!--========================================End of modal for Adding Position==========================-->
                  ...
                  <div class="modal fade bs-example-modal-lg" id="truncate" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <?php echo form_open('admin/positions/truncate','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
