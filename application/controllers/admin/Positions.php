...
class Positions extends CI_Controller
{
	...
	public function index($page='admin/positions')
	{
		...
		$data['positions']=$this->Admin_model->get_position();
	...
	{
		$id=html_escape($id);
		$page='admin/view_position_semester';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$term_result_exists=$this->Admin_model->get_position_session($id);
		...
		$data['positions']=$this->Admin_model->get_position_session($id);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_position_class($id=null)
	{
		...
		$page='admin/view_position_class';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$class_result_exists=$this->Admin_model->get_position_term($sess,$terms);
		...
		$data['positions']=$this->Admin_model->get_position_term($sess,$terms);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_position_students($id=null)
	{
		...
		$page='admin/view_position_students';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$students_result_exists=$this->Admin_model->get_position_class($sess,$terms,$classs);
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Position';
		$data['positions']=$this->Admin_model->get_position_class($sess,$terms,$classs);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_position_type($id=null)
	{
		...
		$page='admin/view_position_type';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$students_result_exists=$this->Admin_model->get_position_student($sess,$terms,$classs,$student);
		if ($students_result_exists->num_rows() <1) 
	    {
	        $this->session->set_flashdata('message', "<div class=\"alert alert-danger alert-dismissable\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button><span>No student has been assigned a position in this class.</span></div>");
		    redirect('admin/positions');	
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Position';
		$data['positions']=$this->Admin_model->get_position_student($sess,$terms,$classs,$student);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_position_type_student($id=null)
	{
		...
		$page='admin/view_position_type_student';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$students_result_exists=$this->Admin_model->get_position_student_type($sess,$terms,$classs,$student,$type);
		if ($students_result_exists->num_rows() <1) 
	    {
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Position';
		$data['positions']=$this->Admin_model->get_position_student_type($sess,$terms,$classs,$student,$type);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
