...
class Results extends CI_Controller
{
	...
	public function index($page='admin/results')
	{
		...
		$data['results']=$this->Admin_model->get_result();
	...
	public function truncate()
	{
		...
		if ($this->form_validation->run() == TRUE)
        {
        	...
        	$id=html_escape($this->input->post('id'));
        	$delete=$this->db->truncate('Result');
        	if ($delete==TRUE) 
	        {
	...
	{
		$id=html_escape($id);
		$page='admin/view_result_term';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$term_result_exists=$this->Admin_model->get_result_session($id);
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Results';
		$data['results']=$this->Admin_model->get_result_session($id);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_result_class($id=null)
	{
		...
		$page='admin/view_result_class';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$class_result_exists=$this->Admin_model->get_result_term($sess,$terms);
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Results';
		$data['results']=$this->Admin_model->get_result_term($sess,$terms);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_result_students($id=null)
	{
		...
		$page='admin/view_result_students';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$students_result_exists=$this->Admin_model->get_result_class($sess,$terms,$classs);
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Results';
		$data['results']=$this->Admin_model->get_result_class($sess,$terms,$classs);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
	...
	public function view_student_result($id=null)
	{
		...
		$page='admin/view_student_result';
		$adminid=$this->session->userdata('adminid');
		$adminsess=$this->session->userdata('Session');
		$general_settings=$this->Web_model->general_settings();
		$students_result_exists=$this->Admin_model->get_result_student($sess,$terms,$classs,$stud);
		if ($students_result_exists->num_rows() <1) 
	    {
		...
		$data['Site_name']=$general_settings->row()->Site_name;
		$data['pagename']='Results';
		$data['results']=$this->Admin_model->get_result_student($sess,$terms,$classs,$stud);
		$data['sessions']=$this->Admin_model->get_session();
		$data['terms']=$this->Admin_model->get_semester();
		$data['classes']=$this->Admin_model->get_classes();
		$this->load->view('admin/templates/homeheader',$data);
